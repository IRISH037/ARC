...
<body>
    ...
    <h1>Mayon Volcano</h1>
    <div class="blue">
    <p>The Mayon Volcano is situated in the southern part of the main island of Luzon, 500 kilometres south of Manila. Towering at a height of 2,462 meters above sea level, it is known for its perfectly conical shape whose natural beauty has inspired a number of legends and art. The most active volcano in the Philippines and one of the most active in the world, having erupted over 51 times in the past four centuries, the most destructive of which is in 1814 when five towns in its periphery were destroyed. Nevertheless, it has developed a culture of resiliency among the inhabitants of its vicinity, who always rebuilt their towns and cultivated their fields after each destructive eruption. </p>
</div>   
    <div class="gallery">
        <img src="img/mayon.jpg" alt="Image 1">
        <img src="img/mayone.jpg" alt="Image 2">
        <img src="img/mayonnn.jpg" alt="Image 3">
        <!-- Add more images as needed -->
    </div>
    <div class="location">
        <element class="strong">
        <h2>Location & Contacts</h2>
        <p><strong>Address:</strong> Legazpi City, Ligao City, Tabaco City</p>
        <p><strong>Phone:</strong> +63 912 345 6789</p>
        <p><strong>Email:</strong> info@mayonvolcano.com</p>
        <div id="map">
        </element>
    </div>
    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d43526.870105133305!2d123.68718510314424!3d13.266626593146777!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x33a1a9954fa1731f%3A0xdff71d3eddd0ea0d!2sMayon%20Volcano!5e1!3m2!1sen!2sph!4v1728367862668!5m2!1sen!2sph" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
     <script>
    ...
    <div class="eateries">
        ...
        <div class="eatery">
            <strong>The Oriental Legazpi</strong><br>
            Address: San Jose, Legazpi City, Albay, Philippines.<br>
        </div>
        <div class="eatery">
            <strong>1st Colonial Grill</strong><br>
            Address: 27 Rizal St, Legazpi City, Albay, Philippines.<br>
        </div>
        <div class="eatery">
            <strong>Small Talk Café</strong><br>
            Address: 17 Rizal St, Legazpi City, Albay, Philippines.<br>
        </div>
 ...
 <section class="section__container popular__container">
    ...
    <div class="popular__grid">
        <div class="popular__card">
            <img src="img/hotel34.jpg" alt="popular hotel" />
            <div class="popular__content">
                <div class="popular__card__header">
                    <h4>HOTEL HERENCIA 625 </h4>
                    <h3>TOP 1</h3>
                </div>
                <p>📍Lakandula Drive Banag,, 4501 Daraga, Philippines</p>
        </div>
    </div>
        <div class="popular__card">
            <img src="img/hotel35.jpg" alt="popular hotel" />
            <div class="popular__content">
                <div class="popular__card__header">
                    <h4>The Marison Hotel</h4>
                    <h3>TOP 2</h3>
                </div>
                <p>📍Corner Imelda Roces Avenue, Barangay 38, Gogon, Bicol, 4500 Legazpi, Philippines</p>
            </div>
        </div>
        <div class="popular__card">
            <img src="img/hotel36.jpg" alt="popular hotel" />
            <div class="popular__content">
                <div class="popular__card__header">
                    <h4>Emerald Boutique Hotel</h4>
                    <h3>TOP 3</h3>
                </div>
                <p>📍Marquez Street, Old Albay District, Albay, 4500 Legazpi, Philippines</p>
        </div>
    </div>
</section>
