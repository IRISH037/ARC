...
<head>
    ...
    <title>Historical Intramuros </title>
    <style>
        body {
...
<body>
    ...
    <div class="gallery">
        <img src="img/intramuros.png" alt="Image 1">
        <img src="img/Intramuross.jpg" alt="Image 2">
        <img src="img/Intramurosss.jpg" alt="Image 3">
    ...
    <div class="location">
        ...
        <p><strong>Email:</strong> info@intramuros.com</p>
        <div id="map">
        </element>
    </div>
    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d6125.626291847753!2d120.9704550907803!3d14.589552640003406!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3397ca3d1375e1fb%3A0x49ebfa658c0ba08!2sIntramuros%2C%20Manila%2C%201002%20Metro%20Manila!5e1!3m2!1sen!2sph!4v1728368216382!5m2!1sen!2sph" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
     <script>
...
<div class="eateries">
    ...
    <div class="eatery">
        ...
        Address:  744 General Luna St, Intramuros, Manila, 1002, Philippines.<br>
    </div>
    <div class="eatery">
        <strong>Ristorante Delle Mitre</strong><br>
    Address: 1 Gen. Luna St, San Agustin, Intramuros, Manila, 1002, Philippines<br>
    </div>
    <div class="eatery">
        <strong>The Alley by Vikings</strong><br>
        Address: 2nd Floor, Ayala Malls Manila Bay, Pasay City<br>
    </div>
</div>
...
<section class="section__container popular__container">
    ...
    <div class="popular__grid">
        <div class="popular__card">
            <img src="img/hotel16.jpg" alt="popular hotel" />
            <div class="popular__content">
                <div class="popular__card__header">
                    <h4>Manila Prince Hotel</h4>
                    <h3>TOP 1</h3>
                </div>
                <p>📍1000 San Marcelino St. Ermita, 1000 Manila, Philippines</p>
            </div>
        </div>
        <div class="popular__card">
            <img src="img/hotel17.jpg" alt="popular hotel" />
            <div class="popular__content">
                <div class="popular__card__header">
                    <h4>Bayview Park Hotel Manila</h4>
                    <h3>TOP 2</h3>
                </div>
                <p>📍1118 Roxas Boulevard Cor., United Nations Avenue, 1000 Manila, Philippines</p>
            </div>
        </div>
        <div class="popular__card">
            <img src="img/hotel18.jpg" alt="popular hotel" />
            <div class="popular__content">
                <div class="popular__card__header">
                    <h4>New Coast Hotel Manila</h4>
                    <h3>TOP 3</h3>
                </div>
                <p>📍1588 Pedro Gil St. cor MH Del Pilar Malate, 1004 Manila, Philippines</p>
            </div>
        </div>
    </div>
</section>
